...
Files: macbook-16.glb [639.28KB] > C:\Users\admin\Desktop\Basic Web Developer\Apple-style-website\Apple-style-website\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if(child.isMesh){
        //Change color only if the part name is NOT noChangePart
